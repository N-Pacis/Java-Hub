...
public class Sedan {
    ...
    public Sedan(Integer mondayPrice, Integer tuesdayPrice, Integer thursdayPrice, Integer fridayPrice, Integer saturdayPrice, Integer sundayPrice) {
