...
public class Main {
    ...
    private static void createTable(){
        try{
            ...
            boolean passed = statement.execute("CREATE TABLE IF NOT EXISTS students(id INT PRIMARY KEY AUTO_INCREMENT, firstname VARCHAR(50) NOT NULL, lastname VARCHAR(50) NOT NULL, gender VARCHAR(50));");
        }
        catch(Exception e){
    ...
    public static void main(String[] args) {
        connectToDatabase();
        createTable();
        insertIntoStudents("doe","john","MALE");
        displayStudents();
    }
}
